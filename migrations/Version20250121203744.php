 ...
 */
final class Version20250121203744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE target (key VARCHAR(22) NOT NULL, source_id VARCHAR(18) NOT NULL, target_locale VARCHAR(6) NOT NULL, engine VARCHAR(12) NOT NULL, target_text TEXT DEFAULT NULL, bing_translation TEXT DEFAULT NULL, marking VARCHAR(32) DEFAULT NULL, PRIMARY KEY(key))');
